  ...
  return (
    ...
    >
      <defs>
        ...
        {/* Node gradients */}
        {/* Nodes separate by luminance, not by hue — three steps of the one
            ramp, alternated around the ring. */}
        <radialGradient id="g-center" cx="50%" cy="35%" r="65%">
          <stop offset="0%" stopColor="#a366ff" />
          <stop offset="100%" stopColor="#3d0099" />
        </radialGradient>
        <radialGradient id="g-node-bright" cx="50%" cy="35%" r="65%">
          <stop offset="0%" stopColor="#efe5ff" />
          <stop offset="100%" stopColor="#6600ff" />
        </radialGradient>
        <radialGradient id="g-node" cx="50%" cy="35%" r="65%">
          <stop offset="0%" stopColor="#a366ff" />
          <stop offset="100%" stopColor="#3d0099" />
        </radialGradient>
        <radialGradient id="g-node-deep" cx="50%" cy="35%" r="65%">
          <stop offset="0%" stopColor="#6600ff" />
          <stop offset="100%" stopColor="#140033" />
        </radialGradient>
      </defs>
      ...
      */}
      ...
      <line x1="280" y1="305" x2="280" y2="70"  stroke="#6600ff" strokeWidth="1.2" strokeOpacity="0.35" strokeDasharray="6 5">
        <animate attributeName="stroke-dashoffset" from="0" to="-22" dur="1.4s" repeatCount="indefinite" />
      </line>
      <line x1="280" y1="305" x2="484" y2="187" stroke="#a366ff" strokeWidth="1.2" strokeOpacity="0.32" strokeDasharray="6 5">
        <animate attributeName="stroke-dashoffset" from="0" to="-22" dur="1.9s" repeatCount="indefinite" />
      </line>
      <line x1="280" y1="305" x2="484" y2="423" stroke="#6600ff" strokeWidth="1.2" strokeOpacity="0.32" strokeDasharray="6 5">
        <animate attributeName="stroke-dashoffset" from="0" to="-22" dur="1.7s" repeatCount="indefinite" />
      </line>
      <line x1="280" y1="305" x2="280" y2="540" stroke="#a366ff" strokeWidth="1.2" strokeOpacity="0.32" strokeDasharray="6 5">
        <animate attributeName="stroke-dashoffset" from="0" to="-22" dur="2.1s" repeatCount="indefinite" />
      </line>
      <line x1="280" y1="305" x2="76"  y2="423" stroke="#6600ff" strokeWidth="1.2" strokeOpacity="0.30" strokeDasharray="6 5">
        <animate attributeName="stroke-dashoffset" from="0" to="-22" dur="1.6s" repeatCount="indefinite" />
      </line>
      <line x1="280" y1="305" x2="76"  y2="187" stroke="#6600ff" strokeWidth="1.2" strokeOpacity="0.28" strokeDasharray="6 5">
        <animate attributeName="stroke-dashoffset" from="0" to="-22" dur="2.3s" repeatCount="indefinite" />
      </line>

      {/* ── Data packets travelling the lines ── */}
      <circle r="4" fill="#efe5ff">
      ...
      <circle cx="280" cy="305" r="108" stroke="#6600ff" strokeWidth="0.6" strokeOpacity="0.10">
      ...
      <circle cx="280" cy="305" r="92" stroke="#6600ff" strokeWidth="0.9" strokeOpacity="0.16">
      ...
      {/* AI/ML — top (280, 70) */}
      <circle cx="280" cy="70"  r="60" fill="url(#g-node-bright)" filter="url(#hero-glow-sm)" />
      ...
      {/* Database — top-right (484, 187) */}
      <circle cx="484" cy="187" r="60" fill="url(#g-node)" filter="url(#hero-glow-sm)" />
      ...
      {/* Frontend — bottom-right (484, 423) */}
      <circle cx="484" cy="423" r="60" fill="url(#g-node-deep)" filter="url(#hero-glow-sm)" />
      ...
      {/* Mobile — bottom (280, 540) */}
      <circle cx="280" cy="540" r="60" fill="url(#g-node-bright)" filter="url(#hero-glow-sm)" />
      ...
      {/* Cloud — bottom-left (76, 423) */}
      <circle cx="76"  cy="423" r="60" fill="url(#g-node)" filter="url(#hero-glow-sm)" />
      ...
      {/* Auth — top-left (76, 187) */}
      <circle cx="76"  cy="187" r="60" fill="url(#g-node-deep)" filter="url(#hero-glow-sm)" />
      ...
      <g transform="translate(356, 230)">
        <rect width="70" height="19" rx="9.5" fill="#a366ff" fillOpacity="0.15" stroke="#a366ff" strokeWidth="0.6" strokeOpacity="0.35" />
      ...
      <g transform="translate(110, 348)">
        <rect width="60" height="19" rx="9.5" fill="#6600ff" fillOpacity="0.15" stroke="#6600ff" strokeWidth="0.6" strokeOpacity="0.35" />
      ...
      <g transform="translate(358, 372)">
        <rect width="66" height="19" rx="9.5" fill="#6600ff" fillOpacity="0.15" stroke="#6600ff" strokeWidth="0.6" strokeOpacity="0.35" />
      ...
      <g transform="translate(288, 170)">
        <rect width="58" height="19" rx="9.5" fill="#6600ff" fillOpacity="0.15" stroke="#6600ff" strokeWidth="0.6" strokeOpacity="0.35" />
